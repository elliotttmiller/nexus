...
const styles = StyleSheet.create({
  ...
  label: { fontWeight: '600', color: '#2d3748', marginBottom: 8, fontSize: 16, marginTop: 8 },
  ...
  resultTitle: { fontWeight: '700', fontSize: 20, marginBottom: 16, color: PRIMARY, textAlign: 'center', marginTop: 8 },
  resultText: { fontSize: 15, color: TEXT, fontWeight: '500' },
  resultExplanation: { marginTop: 12, color: TEXT, fontStyle: 'italic' },
  text: { color: TEXT },
  modalOverlay: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' },
  modalContent: { backgroundColor: '#fff', borderRadius: 16, padding: 24, width: '90%', maxHeight: '80%', alignItems: 'stretch' },
  applyButton: { backgroundColor: PRIMARY, padding: 16, borderRadius: 12, alignItems: 'center', marginTop: 20, width: '100%' },
  applyButtonText: { color: '#fff', fontWeight: '600', fontSize: 16, letterSpacing: 0.5 },
  closeButton: { marginTop: 24, padding: 12, borderRadius: 8, backgroundColor: '#f5f5f5', alignSelf: 'center', paddingHorizontal: 24 },
  closeButtonText: { color: '#555', fontWeight: '500', fontSize: 15 },
  splitRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 12, backgroundColor: '#f9f9f9', borderRadius: 8, marginBottom: 8, borderWidth: 1, borderColor: '#eee' },
  explanationHighlight: { marginTop: 12, marginBottom: 16, color: '#555', fontSize: 14, lineHeight: 20, backgroundColor: '#f8f9ff', padding: 12, borderRadius: 8, borderLeftWidth: 4, borderLeftColor: PRIMARY },
  projectedOutcome: { fontWeight: 'bold', color: '#333', fontSize: 14, marginTop: 4 },
  cardItemPolished: { backgroundColor: SUBTLE, borderRadius: 16, paddingVertical: 22, paddingHorizontal: 18, marginBottom: 16, borderWidth: 1, borderColor: BORDER, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.07, shadowRadius: 8, elevation: 2, minHeight: 110, justifyContent: 'center' },
  cardItemSelectedPolished: { backgroundColor: PRIMARY + '18', borderColor: PRIMARY, shadowOpacity: 0.13, shadowRadius: 12, elevation: 4 },
  institutionName: { fontSize: 12, color: '#888', fontWeight: '500', marginBottom: 2, marginLeft: 2 },
  cardTopRowPolished: { flexDirection: 'row', alignItems: 'center', marginBottom: 2 },
  accountNamePolished: { fontSize: 16, fontWeight: 'bold', color: '#222', marginBottom: 1 },
  accountNumberPolished: { fontSize: 13, color: '#888', marginBottom: 2 },
  accountBalancePolished: { fontSize: 22, fontWeight: 'bold', color: PRIMARY, marginLeft: 8, marginRight: 2 },
  dividerPolished: { height: 1, backgroundColor: BORDER, marginVertical: 10, borderRadius: 1, opacity: 0.7 },
  metricsRowPolished: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  metricTextPolished: { fontSize: 13, color: '#757575', marginRight: 8, fontWeight: '500' },
  healthBarRowPolished: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  healthLabelPolished: { fontSize: 12, color: '#757575', marginLeft: 6, fontWeight: 'bold' },
  splitCardContainer: { backgroundColor: '#f4f8f7', borderRadius: 12, paddingVertical: 14, paddingHorizontal: 18, marginBottom: 12, borderWidth: 1, borderColor: '#e0e0e0', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 2, elevation: 1 },
  splitCardLabel: { fontSize: 15, color: '#222', fontWeight: '600' },
  splitCardNumber: { fontSize: 15, color: PRIMARY, fontWeight: 'bold', letterSpacing: 1.5 },
  splitCardAmountDisplay: { fontSize: 17, color: PRIMARY, fontWeight: 'bold', minWidth: 70, textAlign: 'right', borderBottomWidth: 1.5, borderBottomColor: 'transparent', paddingVertical: 2 },
  splitCardType: { fontSize: 13, color: '#757575', marginTop: 4, fontWeight: '500' },
  fundingAccountContainer: { backgroundColor: '#f7fafd', borderRadius: 12, paddingVertical: 13, paddingHorizontal: 17, marginBottom: 10, borderWidth: 1, borderColor: '#e0e0e0', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 2, elevation: 1 },
  fundingAccountSelected: { borderColor: PRIMARY, backgroundColor: PRIMARY + '10', shadowOpacity: 0.08, shadowRadius: 4, elevation: 2 },
  fundingAccountLabel: { fontSize: 15, color: '#222', fontWeight: '600' },
  fundingAccountNumber: { fontSize: 15, color: PRIMARY, fontWeight: 'bold', letterSpacing: 1.5 },
  fundingAccountBalance: { fontSize: 16, color: PRIMARY, fontWeight: 'bold' },
  fundingAccountType: { fontSize: 13, color: '#757575', marginTop: 4, fontWeight: '500' },
  resetButton: { backgroundColor: '#f2f2f2', borderRadius: 8, paddingVertical: 10, paddingHorizontal: 18, alignItems: 'center', marginTop: 8, marginBottom: 4, alignSelf: 'flex-end' },
  resetButtonText: { color: PRIMARY, fontWeight: '600', fontSize: 15, letterSpacing: 0.2 },
  aiLoadingOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.18)', justifyContent: 'center', alignItems: 'center', zIndex: 100 },
  aiLoadingBox: { backgroundColor: '#fff', borderRadius: 16, paddingVertical: 32, paddingHorizontal: 36, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 6 },
  aiLoadingText: { marginTop: 18, fontSize: 16, color: PRIMARY, fontWeight: '600', letterSpacing: 0.2 },
}); 